...
import net.mcreator.sao_legacy.procedure.ProcedureForgeGUIGetLevel;
...
public class GuiForgeGUI extends ElementsTheSAOLegacyMod.ModElement {
	public static int GUIID = 4;
	public static HashMap guistate = new HashMap();
	public GuiForgeGUI(ElementsTheSAOLegacyMod instance) {
		super(instance, 87);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 116, 30) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("sao_legacy:textures/forgegui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Forge", 74, -15, -1);
			this.fontRenderer.drawString("" + ((int) entity.getEntityData().getDouble("blacksmithLevel")) + "", 178, 20, -103);
			this.fontRenderer.drawString("Current Smithing Level:", 178, 2, -1);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 99, this.guiTop + 56, 50, 20, "FORGE"));
			this.buttonList.add(new GuiButton(1, this.guiLeft + 178, this.guiTop + 38, 60, 20, "Retest"));
		}
		...
		if (buttonID == 1) {
			{
				...
				ProcedureForgeGUIGetLevel.executeProcedure($_dependencies);
			}
		}
	}
