...
import net.mcreator.sao_legacy.procedure.ProcedureDismantle;
...
public class GuiDeconstructor extends ElementsTheSAOLegacyMod.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiDeconstructor(ElementsTheSAOLegacyMod instance) {
		super(instance, 80);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 17, 30) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 134, 12) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 152, 12) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 134, 30) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			...
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 134, 48) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("sao_legacy:textures/deconstructor.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Dismantling Table", 44, -16, -1);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 16, this.guiTop + 56, 90, 20, "DISMANTLE"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureDismantle.executeProcedure($_dependencies);
			}
		}
	}
