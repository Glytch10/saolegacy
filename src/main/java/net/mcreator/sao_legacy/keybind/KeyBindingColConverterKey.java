...
package net.mcreator.sao_legacy.keybind;
...
import net.mcreator.sao_legacy.procedure.ProcedureColConverterKeyOpenGUI;
...
public class KeyBindingColConverterKey extends ElementsTheSAOLegacyMod.ModElement {
	private KeyBinding keys;
	public KeyBindingColConverterKey(ElementsTheSAOLegacyMod instance) {
		super(instance, 70);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.colconverterkey", Keyboard.KEY_APOSTROPHE, "key.categories.misc");
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		if (Minecraft.getMinecraft().currentScreen == null) {
			if (org.lwjgl.input.Keyboard.isKeyDown(keys.getKeyCode())) {
				TheSAOLegacyMod.PACKET_HANDLER.sendToServer(new KeyBindingPressedMessage());
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureColConverterKeyOpenGUI.executeProcedure($_dependencies);
		}
	}
}
