...
import net.mcreator.sao_legacy.procedure.ProcedureDash;
...
public class KeyBindingDashKey extends ElementsTheSAOLegacyMod.ModElement {
	private KeyBinding keys;
	public KeyBindingDashKey(ElementsTheSAOLegacyMod instance) {
		super(instance, 79);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.dashkey", Keyboard.KEY_LMENU, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureDash.executeProcedure($_dependencies);
		}
	}
}
