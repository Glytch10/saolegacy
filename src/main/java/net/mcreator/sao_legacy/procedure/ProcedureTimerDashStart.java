...
public class ProcedureTimerDashStart extends ElementsTheSAOLegacyMod.ModElement {
	public ProcedureTimerDashStart(ElementsTheSAOLegacyMod instance) {
		super(instance, 93);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure TimerDashStart!");
			return;
		}
