...
public class ProcedureOnPlayerJoin extends ElementsTheSAOLegacyMod.ModElement {
	public ProcedureOnPlayerJoin(ElementsTheSAOLegacyMod instance) {
		super(instance, 84);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure OnPlayerJoin!");
			return;
		}
		...
		if (!world.isRemote && world.getMinecraftServer() != null) {
			...
			}, "scoreboard objectives add blacksmithing dummy");
		}
		if (!world.isRemote && world.getMinecraftServer() != null) {
			world.getMinecraftServer().getCommandManager().executeCommand(new ICommandSender() {
				@Override
		...
		if (!world.isRemote && world.getMinecraftServer() != null) {
			...
			}, "scoreboard objectives setdisplay sidebar.team.white yaw");
		}
	}
